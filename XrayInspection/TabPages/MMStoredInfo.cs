    ...
    public partial class MMStoredInfo : UserControl
    {
        ...
        private void NewCtrl_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                while (parentfrm.Parent != null && parentfrm.GetType().ToString() != "XrayInspection.PopUp.MainFrm")
                {
                    parentfrm = parentfrm.Parent;
                }

                (parentfrm as XrayInspection.PopUp.MainForm).SetMaskDatas(obj.RackName);
